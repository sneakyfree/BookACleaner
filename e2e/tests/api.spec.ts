...
test.describe('API Integration', () => {
  // 8000, not 8002 — matches playwright.config.ts's webServer and the port
  // apps/web/next.config.js proxies /api/v1/* to. The old 8002 default meant
  // these tests hit a port nothing was listening on.
