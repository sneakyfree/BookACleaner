...
export default function MessagesPage() {
    ...
    const conversations = [
        {
            id: '1',
            participant: { name: 'John D.', role: 'Client', avatar: null, rating: 4.8 },
            lastMessage: 'Thanks! See you tomorrow at 10am.',
        ...
        {
            id: '2',
            participant: { name: 'Sarah M.', role: 'Client', avatar: null, rating: 5.0 },
            lastMessage: 'Can you do an early morning slot?',
        ...
        {
            id: '3',
            participant: { name: 'Mike R.', role: 'Client', avatar: null, rating: 4.9 },
            lastMessage: 'Perfect, the code is 1234#',
    ...
    const messages = [
        ...
        },
        {
            id: '6',
            senderId: 'me',
            content: 'Perfect! I\'ve received the booking. The address is 123 Lake Street, correct?',
            timestamp: '10:42 AM',
            read: true,
        },
        {
            id: '7',
            senderId: 'other',
            content: 'Thanks! See you tomorrow at 10am.',
            timestamp: '10:45 AM',
            read: true,
        },
    ]
                            ...
                            >
                                <div className="flex gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-muted-foreground">{convo.property}</p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            <span>{selectedConvo.participant.role}</span>
                                            <span>•</span>
                                            ...
                                            <span>•</span>
                                            <span>{selectedConvo.property}</span>
                                        </div>
                                    </div>
                                </div>
