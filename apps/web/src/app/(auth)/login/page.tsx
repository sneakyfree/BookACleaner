            ...
            <Card className="w-full max-w-md bg-white/5 backdrop-blur-xl border-white/10">
                ...
                <CardContent className="space-y-6">
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        className="w-full bg-white/10 text-white/50 border-white/10 cursor-not-allowed"
                        disabled={true}
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="pl-10 bg-white/5 border-white/10 text-white placeholder:text-white/30 focus:border-brand-500 focus:ring-brand-500"
                                />
                            </div>
                        </div>
